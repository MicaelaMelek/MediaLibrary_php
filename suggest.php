        ...
        <?php
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><select id="category" name="category" value="<?php if(isset($name)){echo $name;} ?>">
                ...
                <tr>
                    ...
                    <td><input type="text" id="title" name="title" value="<?php if(isset($name)){echo $name;} ?>"/></td>
                </tr>
                <tr>
                    <th>
                ...
                <tr style="display:none">
                    ...
                    <!--<p>Please leave this field in blank</p>-->
                </tr>
            </table>
